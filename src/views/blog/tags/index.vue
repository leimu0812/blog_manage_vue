    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['blog:tags:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()"
              v-hasPermi="['blog:tags:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()"
              v-hasPermi="['blog:tags:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport"
              v-hasPermi="['blog:tags:export']">导出</el-button>
          </el-col>
      ...
      <el-table v-loading="loading" :data="tagsList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="标签类型" align="center" prop="type">
          <template #default="scope">
            ...
            <!-- <dict-tag :options="listClassOptions" :value="scope.row.type" /> -->
          </template>
        </el-table-column>
          ...
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                v-hasPermi="['blog:tags:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                v-hasPermi="['blog:tags:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { TagsVO, TagsQuery, TagsForm } from '@/api/blog/tags/types';
...
const handleDelete = async (row?: TagsVO) => {
  ...
  await proxy?.$modal.confirm('是否确认删除文章标签管理编号为"' + _ids + '"的数据项？').finally(() => loading.value = false);
  await delTags(_ids);
